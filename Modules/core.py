...
from Modules.numba_target import use_cuda

if use_cuda:
    import numba.cuda as cuda
    
import Modules.leapfrog as leapfrog
import Modules.leapfrog_cuda as leapfrog_cuda
...
class Simulation:
    def __init__(self, n, dt, g):
        ...
        """
        print("self.n = ", self.n, n)
        print("self.dt = ", self.dt, dt)
        print("self.g = ", self.g, g)
        print("self.nn2 = ", self.n ** 2, nn)
        """
