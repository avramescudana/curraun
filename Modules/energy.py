from Modules.numba_target import myjit, prange, my_parallel_loop, use_cuda, mynonparjit
...
class Energy():
    ...
    def compute(self):
        ...
        # ====================================== By Pooja ======================================
        self.Epsilon_0   =  self.energy_density
        self.Pressure_L  =  self.pL
        self.Pressure_T  =  self.pT

        self.ED_EL =  self.EL_mean
        self.ED_ET =  self.ET_mean
        self.ED_BL =  self.BL_mean
        self.ED_BT =  self.BT_mean
        # ======================================================================================
