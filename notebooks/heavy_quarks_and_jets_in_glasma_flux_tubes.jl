...
# ╔═╡ 31168d4c-c1d2-11ee-12ae-837fda7e7647
begin
	using Pickle
	using CairoMakie
...
# ╔═╡ 9a2f0071-b49d-4496-b978-0d9e22697d6f
pwd()

# ╔═╡ afdd3af8-f964-42e6-851d-27d447271ac8
begin
	
	data_particles = Pickle.npyload("flux_tubes_su3_jets.pickle")
	quarks, pTs = data_particles["quarks"], data_particles["pTs"]
	xT, p, tau = data_particles["xT"], data_particles["pT"], data_particles["tau"]
	
	data_fields = Pickle.npyload("energy_density_su3.pickle")
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "6443d134b0d7e6b119afb6364046ec1df51f5690"
