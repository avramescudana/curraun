...
# ╔═╡ 1833f082-5f0a-11ef-19b6-45eadcaa34e5
begin
...
# ╔═╡ ea37827e-eb7a-458e-a0b4-4626a4a6564b
begin
	using Conda
	Conda.add("libstdcxx-ng", version="GLIBCXX_3.4.30")
end

# ╔═╡ 17492111-ee4e-450c-ab2c-1e7e1c1b18d8
begin
	using Pickle
	using DataFrames
end

# ╔═╡ bccf716b-2c1f-42d3-8cb3-87cf617d520c
begin
...
# ╔═╡ 10579d14-c42d-475d-a5e0-91e13ca92152
current_path = pwd()

# ╔═╡ 5ab9444d-23cd-47b0-9084-758473de0195
function findminindex(value, array)
	return findmin(element->abs(element-value),array)[2]
end 

# ╔═╡ 2179d3d4-fb50-4706-828b-46e399fa368b
...
# ╔═╡ 74cc468d-7767-496b-9296-279af2ae52ab
begin
	τₛ = [0.05, 0.3, 1.0]
	pTₛ = [0, 2, 10]
end

# ╔═╡ 74ecf0bb-55dd-4c98-8e98-7031569a3686
begin
	quark = "charm"
...
# ╔═╡ 8c0feb16-d6ff-4e1f-8a6c-a57d313ec5f1
dfᵢ

# ╔═╡ 94a29689-8d1c-403c-8ced-206110e11905
begin
	data_dict = Dict(Symbol(k) => DataFrames.select(dfᵢ, k)[:, 1] for k in names(dfᵢ))
	df_pandas = pd.DataFrame(PyObject(data_dict))
end

# ╔═╡ 5f9064db-a9b4-4441-b9a3-efd781cc6ee7
begin
	sns.kdeplot(x="Δϕᵢ", y="Δηᵢ", data=df_pandas)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "05aa509843614c6a1cd5be7fe8a3a92e48a2ee92"
