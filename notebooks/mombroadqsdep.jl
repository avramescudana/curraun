...
begin
	...
	axes = reshape([Axis(fig[j, i], xlabel=xlabel[j], ylabel=ylabels[i, j], xlabelsize = 20, ylabelsize= 20, xticklabelsize=14, yticklabelsize=14, xtickalign = 1, xticksize=4, ytickalign=1, yticksize=4, xgridvisible = false, ygridvisible = false) for i in 1:3 for j in 1:2], 2, 3)
	...
	cbar = Colorbar(fig[1:2, 4], limits = (1, 6), colormap =  cgrad(colors, 5, categorical = true), size = 25, labelsize = 22, width = 10, flipaxis = true,
