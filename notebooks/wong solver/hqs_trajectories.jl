...
# ╔═╡ 7beefde2-c761-11ee-1320-a7f0c3e208a3
begin
	using Pickle
	using CairoMakie
...
# ╔═╡ 4744d7b0-c0b8-4116-8856-d6c757f8f322
# ╠═╡ disabled = true
#=╠═╡
begin
...
# ╔═╡ d3395e4a-d7e1-4cc7-8ef5-64d945266339
begin
	data_particles = Pickle.npyload("trajectories_new.pickle")
	quarks, pTs = data_particles["quarks"], data_particles["pTs"]
	xT, p, tau = data_particles["xT"], data_particles["pT"], data_particles["tau"]
	
	data_fields = Pickle.npyload("energy_density_background_new.pickle")
	...
	ax = Axis(fig[2, 1], aspect=1, 
	        xlabel=L"p^x\,\mathrm{[GeV]}", ylabel=L"p^y\,\mathrm{[GeV]}",
	...
	a = L/N
	δx = 2
	xlow, xhigh, ylow, yhigh = -δx, δx, -δx, δx
	...
	cbar = Colorbar(fig, hmap, label = L"\epsilon_\mathrm{form}\,\mathrm{[GeV/fm^3]}", labelsize = 22, width = 15, flipaxis = true,
	...
	#     #         ticksize=2, tickalign = 1, ticklabelsize = 14, width = Relative(3.72/4), height = 7)
	#     #     fig[1, 1] = cbarline
	#     # end
	#     rowgap!(fig.layout, 7)
	...
	# save("plots/hqs_trajectories_beauty.png", fig, px_per_unit = 5.0) 
	fig
end
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "a0b15b47f472de0f1b1b601ad8aed66f375006dc"
