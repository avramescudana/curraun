...
def compute_vlc(vlc0, vlc1, xplus, t, n, u1, aeta1):
    # t = s.t
    # n = s.n
    # u1 = s.d_u1
    # aeta1 = s.d_aeta1

    my_parallel_loop(compute_vlc_kernel, n*n, n, t, u1, aeta1, vlc0, vlc1, xplus)  

@myjit
def compute_vlc_kernel(zi, n, t, u1, aeta1, vlc0, vlc1, xplus):
    yz = l.get_point(zi, n)
