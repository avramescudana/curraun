...
class CoulombGaugeTransf:
    def __init__(self, s):
        ...
        self.delta_alg = np.zeros((nn, su.ALGEBRA_ELEMENTS), dtype=su.GROUP_TYPE_REAL)
        self.c_alg = np.zeros((nn, su.ALGEBRA_ELEMENTS), dtype=su.GROUP_TYPE_REAL)
        ...
        #TODO: algebra color elements debugging
        self.d_delta_alg = self.delta_alg
        self.d_c_alg = self.c_alg
    ...
    def copy_to_device(self):
        ...
        #TODO: algebra color elements debugging
        self.d_delta_alg = cuda.to_device(self.delta_alg)
        self.d_c_alg = cuda.to_device(self.c_alg)
    ...
    def copy_to_host(self):
        ...
        #TODO: algebra color elements debugging
        self.d_delta_alg.copy_to_host(self.delta_alg)
        self.d_c_alg.copy_to_host(self.c_alg)
...
def init_gauge_transform(self):
    ...
    # init_transf_random(self.s, self.d_g0)
...
def gauge_transform(self, alpha):
    ...
    # fourier_acceleration(self.s, self.d_delta, alpha, self.d_c)
